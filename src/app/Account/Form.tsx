  ...
  return (
    <div className="w-full max-w-md mx-auto bg-white p-6 rounded-lg shadow-lg">
      ...
      <button
        ...
        className="mt-6 w-full bg-secondary border-2 border-secondary text-white py-2 px-4 rounded-md hover:bg-white hover:text-secondary duration-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
      >
        Update
      </button>
    </div>
